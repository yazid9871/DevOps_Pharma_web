*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de inventaire"
...
Force Tags        Page de création de inventaire
...
*** Test Cases ***
Accéder à la page de création de inventaire
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des inventaire,
     ...                puis ouverture de la page de création d'un nouveau inventaire.
     Accéder à la page    purchaseorders
     Aller à la page de création de inventaire
