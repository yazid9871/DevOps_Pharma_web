*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de devis : Recherche_Produit_"
...
Force Tags        Page de création de devis :Recherche_Produit_
...
*** Test Cases ***
Accéder à la page de création de devis
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des devis,
     ...                puis ouverture de la page de création d'un nouveau devis.
     Accéder à la page    quotes
     Aller à la page de création de devis
