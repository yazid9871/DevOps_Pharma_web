*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de devis: verify_calcule_de_discount"
...
Force Tags        Page de création de devis :verify_calcule_de_discount
...
aller à la page de création de devis
    ...
    Aller à la page de liste des devis
    aller à la page de création de devis
