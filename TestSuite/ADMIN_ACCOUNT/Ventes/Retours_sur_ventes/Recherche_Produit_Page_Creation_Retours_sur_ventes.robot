*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Retours sur ventes"
...
Force Tags        Page de création de Retours sur ventes
...
*** Test Cases ***
Accéder à la page de création de Retours sur ventes
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des Retours sur ventes,
     ...                puis ouverture de la page de création d'un nouveau Retours sur ventes.
     Accéder à la page    salesreturns
     Aller à la page de création de Retours sur ventes
