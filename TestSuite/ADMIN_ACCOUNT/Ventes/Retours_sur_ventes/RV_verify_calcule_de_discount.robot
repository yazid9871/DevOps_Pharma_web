*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Retours sur ventes :verify_calcule_de_discount"
...
Force Tags        Page de création de Retours sur ventes : verify_calcule_de_discount
...
aller à la page de création de Retours sur ventes
    ...
    Aller à la page de liste des Retours sur ventes
    aller à la page de création de Retours sur ventes
