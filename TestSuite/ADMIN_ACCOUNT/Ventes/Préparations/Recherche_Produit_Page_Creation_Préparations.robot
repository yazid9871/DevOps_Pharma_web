*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Préparations"
...
Force Tags        Page de création de Préparations
...
*** Test Cases ***
Accéder à la page de création de Préparations
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des Préparations,
     ...                puis ouverture de la page de création d'un nouveau Préparations.
