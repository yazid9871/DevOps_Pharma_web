...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapport sur stock par forme galénique"
...
Force Tags      Rapport sur stock par forme galénique
