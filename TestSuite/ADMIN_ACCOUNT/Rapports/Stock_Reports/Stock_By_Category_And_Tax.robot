...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports  Stock par famille tarifaire (Catégorie et TVA)"
...
Force Tags       Rapports  Stock par famille tarifaire (Catégorie et TVA)
...
${TITRE_PAGE}       Stock par famille tarifaire (Catégorie et TVA)
${refresh}      css=.sob-v2-btn-tertiary
*** Test Cases ***

UC01 - Consulter le rapport
   [Documentation]    Vérifier affichage du rapport
      Accéder à la page  reports/stockbycategoryandtax
