...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports Exporter les ventes"
...
Force Tags     Rapports Exporter les ventes
...
${TITRE_PAGE}              Exporter les ventes
${start_date}          id=start_date
${end_date}            id=end_date
*** Test Cases ***
Vérifier l'affichage de la page Exportation de vente
           Accéder à la page  reports/exportsales
