...
*** Settings ***
Documentation     Tests fonctionnels de la page " Rapport   Rapport sur ventes par jour"
...
Force Tags       Rapport  Rapport sur ventes par jour
