...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports   Achats par fournisseur"
...
Force Tags       Rapports Achats par fournisseur
...
${DATE_END}         31/03/2026
${TITRE_PAGE}         Achats par fournisseur
...
UC05 - Vérifier affichage colonnes
    ...
    Page Should Contain     Total BL
    Page Should Contain    Total avoirs émis
    Page Should Contain     Total avoirs en attente
    Page Should Contain    Total avoirs acceptés
    Page Should Contain     Total avoirs refusés
    Page Should Contain     Net à payer
