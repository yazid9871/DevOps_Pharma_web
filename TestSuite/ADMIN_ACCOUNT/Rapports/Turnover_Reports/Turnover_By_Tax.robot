...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports Chiffre d'affaires par TVA"
...
Force Tags       Rapports Chiffre d'affaires par TVA
