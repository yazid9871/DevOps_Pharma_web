*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de BL"
...
Force Tags        Page de création de BL
...
*** Test Cases ***
Accéder à la page de création de BL
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des BL,
     ...                puis ouverture de la page de création d'un nouveau BL.
     Accéder à la page    deliverynotes
     Aller à la page de création de BL
