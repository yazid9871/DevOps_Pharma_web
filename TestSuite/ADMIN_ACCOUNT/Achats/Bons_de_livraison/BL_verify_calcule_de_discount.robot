*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de BL :verify_calcule_de_discount"
...
Force Tags        Page de création de bl: verify_calcule_de_discount
...
aller à la page de création de BL
    ...
    Aller à la page de liste des BL
    aller à la page de création de BL
choisie fournissuer
      select supplier      Grossiste BIG PARA
...
Sélectionner des produits
     [Arguments]     ${product1}
     sleep     3s
     wait until element is visible     ${SEARCH_FIELD_CODEBARRE}   10s
