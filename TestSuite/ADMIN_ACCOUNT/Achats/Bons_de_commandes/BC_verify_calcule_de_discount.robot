*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de BC :verify_calcule_de_discount"
...
Force Tags        Page de création deBC: verify_calcule_de_discount
...
aller à la page de création de BC
    ...
    Aller à la page de liste des BC
    aller à la page de création de BC
