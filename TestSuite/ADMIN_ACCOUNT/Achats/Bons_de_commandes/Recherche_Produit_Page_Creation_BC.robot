*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de BC"
...
Force Tags        Page de création de BC
...
*** Test Cases ***
Accéder à la page de création de BC
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des BC,
     ...                puis ouverture de la page de création d'un nouveau BC.
     Accéder à la page    purchaseorders
     Aller à la page de création de BC
