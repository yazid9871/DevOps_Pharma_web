*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Entrées confrères :verify_calcule_de_discount"
...
Force Tags        Page de création de Entrées confrères : verify_calcule_de_discount
...
*** Test Cases ***
aller à la page de création de Entrées confrères

    Aller à la page de liste des Entrées confrères
    aller à la page de création de Entrées confrères
...
Aller à la page de liste des Entrées confrères
    ...
    Go To    ${BASE_URL}/colleagues/purchases/create?pricing_field=sale_price
aller à la page de création de Entrées confrères
