*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de entrée confrère"
...
Force Tags        Page de création de entrée confrère
...
Accéder à la page de création de Sorties confrères
     ...
     Accéder à la page     colleagues/purchases/create?pricing_field=sale_price
...
Vérifier que le colleague_name sélectionné est correct
    wait until element is visible    id=-colleague_name
