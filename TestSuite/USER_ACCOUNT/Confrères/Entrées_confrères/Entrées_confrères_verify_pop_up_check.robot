*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Entrées_confrères :verify_pop_up_check"
...
Force Tags        Page de création de Entrées_confrères : verify_pop_up_check
...
*** Test Cases ***
go to create Entrées_confrères page
