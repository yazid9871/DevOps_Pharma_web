*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Sorties confrères :verify_calcule_de_discount"
...
Force Tags        Page de création de Sorties confrères : verify_calcule_de_discount
...
*** Test Cases ***
aller à la page de création de Sorties confrères

    Aller à la page de liste des Sorties confrères
    aller à la page de création de Sorties confrères
...
Aller à la page de liste des Sorties confrères
    ...
    Go To    ${BASE_URL}/colleagues/sales/create?pricing_field=sale_price
aller à la page de création de Sorties confrères
