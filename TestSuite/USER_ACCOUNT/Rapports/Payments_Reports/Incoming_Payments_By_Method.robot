*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports  Encaissements par méthode de paiement"
...
Force Tags       Rapports Encaissements par méthode de paiement
