...
*** Settings ***
Documentation     Tests fonctionnels de la page "Rapports Ventes par laboratoire"
...
Force Tags       Rapports Ventes par laboratoire
...
UC03 choise Fournisseur
    [Documentation]
     sleep    2s
     wait until element is visible      xpath=//input[@id='supplier_id']      10s
