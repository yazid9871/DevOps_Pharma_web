*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de Avoirs fournisseurs émis"
...
Force Tags        Page de création de    Avoirs fournisseurs émis
*** Variables ***
...
*** Test Cases ***
Accéder à la page de création deAvoirs fournisseurs émis
     [Documentation]    Vérifie la navigation : connexion, accès à la liste des Avoirs fournisseurs émis,
     ...                puis ouverture de la page de création d'un nouveau Avoirs fournisseurs émis.
     Accéder à la page    purchasesissuedreturns
     Aller à la page de création deAvoirs fournisseurs émis

Vérifier le choix du Fournisseur
     ...
     Cliquer sur le champ Fournisseur
     Sélectionner le Fournisseur dans le popup
...
*** Keywords ***
Aller à la page de création de Avoirs fournisseurs émis
