*** Settings ***
Documentation     Tests fonctionnels de la page "Page de création de  Avoirs fournisseurs émis :verify_calcule_de_discount"
...
Force Tags        Page de création de  Avoirs fournisseurs émis : verify_calcule_de_discount
...
aller à la page de création de Avoirs fournisseurs émis
    ...
    Aller à la page de liste des Avoirs fournisseurs émis
    aller à la page de création de Avoirs fournisseurs émis
...
Aller à la page de liste des Avoirs fournisseurs émis
    ...
    Go To    ${BASE_URL}/purchasesissuedreturns
